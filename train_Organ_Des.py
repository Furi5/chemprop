...
hyperparameter_arguments = [
    ...
    '--hyperopt_checkpoint_dir', f'checkpoints/DMPNN_Des/{task}_hyperopt',
    ...
    '--config_save_path', f'checkpoints/DMPNN_Des/{task}_hyperopt/config.json',
    '--log_dir', f'checkpoints/DMPNN_Des/{task}_hyperopt',
]
