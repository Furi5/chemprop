...
#     '--hyperopt_checkpoint_dir', f'checkpoints/DMPNN/{task}/{task}_hyperopt',
...
#     '--config_save_path', f'checkpoints/DMPNN/{task}/{task}_hyperopt/config.json',
#     '--log_dir', f'checkpoints/DMPNN/{task}/{task}_hyperopt',
# ]
